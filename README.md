# `SBML_jll.jl` (v5.21.0+0)

[![deps](https://juliahub.com/docs/SBML_jll/deps.svg)](https://juliahub.com/ui/Packages/General/SBML_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/2e891d40e2b6fa275f9f5646bd94bd93e3d82606/S/SBML/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/sbmlteam/libsbml.git (revision: `db4dc4f0d6887cd7cef4761b9606142356d2b735`)
